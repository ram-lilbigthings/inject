...
async function pools(pagination) {
    ...
    try {
        const res = await this.instance(`pools`, {
            searchParams: {
...
async function poolsRetired(pagination) {
    const paginationOptions = (0, utils_1.getPaginationOptions)(pagination);
    try {
        const res = await this.instance(`pools/retired`, {
            searchParams: {
                page: paginationOptions.page,
                count: paginationOptions.count,
                order: paginationOptions.order,
...
async function poolsRetiring(pagination) {
    const paginationOptions = (0, utils_1.getPaginationOptions)(pagination);
    try {
        const res = await this.instance(`pools/retiring`, {
            searchParams: {
                page: paginationOptions.page,
                count: paginationOptions.count,
                order: paginationOptions.order,
...
async function poolsById(poolId) {
    try {
        const res = await this.instance(`pools/${poolId}`);
        return res.body;
    }
    catch (error) {
        throw (0, errors_1.handleError)(error);
...
async function poolsByIdHistory(poolId, pagination) {
    const paginationOptions = (0, utils_1.getPaginationOptions)(pagination);
    try {
        const res = await this.instance(`pools/${poolId}/history`, {
            searchParams: {
                page: paginationOptions.page,
                count: paginationOptions.count,
                order: paginationOptions.order,
...
async function poolMetadata(poolId) {
    try {
        const res = await this.instance(`pools/${poolId}/metadata`);
        return res.body;
    }
    catch (error) {
        throw (0, errors_1.handleError)(error);
...
async function poolsByIdRelays(poolId) {
    try {
        const res = await this.instance(`pools/${poolId}/relays`);
        return res.body;
    }
    catch (error) {
        throw (0, errors_1.handleError)(error);
...
async function poolsByIdDelegators(poolId, pagination) {
    const paginationOptions = (0, utils_1.getPaginationOptions)(pagination);
    try {
        const res = await this.instance(`pools/${poolId}/delegators`, {
            searchParams: {
                page: paginationOptions.page,
                count: paginationOptions.count,
                order: paginationOptions.order,
...
async function poolsByIdBlocks(poolId, pagination) {
    const paginationOptions = (0, utils_1.getPaginationOptions)(pagination);
    try {
        const res = await this.instance(`pools/${poolId}/blocks`, {
            searchParams: {
                page: paginationOptions.page,
                count: paginationOptions.count,
                order: paginationOptions.order,
...
async function poolsByIdUpdates(poolId, pagination) {
    const paginationOptions = (0, utils_1.getPaginationOptions)(pagination);
    try {
        const res = await this.instance(`pools/${poolId}/updates`, {
            searchParams: {
                page: paginationOptions.page,
                count: paginationOptions.count,
                order: paginationOptions.order,
...
async function poolsExtended(pagination) {
    const paginationOptions = (0, utils_1.getPaginationOptions)(pagination);
    try {
        const res = await this.instance(`pools/extended`, {
            searchParams: {
                page: paginationOptions.page,
                count: paginationOptions.count,
                order: paginationOptions.order,
